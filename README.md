...
Данная команда делает то же самое, что и "npm install", но выкачивает дополнительно через git платформенные
репозитории, необходимые для работы шаблонизатора в билдере.
...
_Значение по умолчанию:_ **false**.\
Флаг установлен в значение _false_:
![GitHub Logo](/images/sourceMaps-false.png)
Флаг установлен в значение _true_:
![GitHub Logo](/images/sourceMaps.png)
#### 18) tsc
...
_Принимаемые значения:_ **адрес хоста в виде строки. Пример: "localhost:8080"**.\
_Значение по умолчанию:_ **false**.\
#### 20) checkConfig
...
во всех темах.
_Принимаемые значения:_ **false/true/[<список тем, включая их модификаторы>]**.\
_Значение по умолчанию:_ **true**.\
#### 22) ESVersion
С помощью этого флага можно задать, в какой ES-спецификации нужно собирать TS/JS код проекта
_Принимаемые значения:_ **5/2015/2016/.../2021/**.\
_Значение по умолчанию:_ **5**.\
...
Пример задания builder.json смотрите также [здесь](https://git.sbis.ru/saby/ui/blob/rc-20.1000/buildTemplate.json)
...
Пример подобного задания можете посмотреть [здесь.](https://git.sbis.ru/saby/ui/blob/rc-20.1000/package.json#L19)
