...
class TaskParameters {
   ...
   addCurrentModuleInputs(moduleName, meta) {
      if (!this.moduleInputs[moduleName]) {
         this.moduleInputs[moduleName] = [];
      }

      meta.forEach((currentInput) => {
         if (!this.moduleInputs[moduleName].includes(currentInput)) {
            this.moduleInputs[moduleName].push(currentInput);
         }
      });
   }
