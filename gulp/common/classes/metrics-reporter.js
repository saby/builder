/**
 * Класс, описывающий API для сохранения метрик и артефактов работы билдера
 * @author Krylov M.A.
 */
'use strict';
...
class MetricsReporter {
   ...
   applyOutputArtifacts(taskParameters, outputFiles) {
      this.changedModules = { };
      ...
      taskParameters.config.modules.forEach((moduleInfo) => {
         ...
         const failedFiles = toValidArray(taskParameters.cache.getFailedFiles(moduleInfo.name));
