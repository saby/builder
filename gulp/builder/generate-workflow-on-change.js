...
const Cache = require('./classes/cache'),
   ...
   { generateReadModuleCache, generateWriteModuleCache } = require('./classes/modules-cache'),
   ...
   return function compileFile() {
      ...
      return (
         gulp
            ...
            .pipe(handlePipeException('compileModule', taskParameters, currentModuleInfo))
            .pipe(toPosixVinyl(currentModuleInfo))
...
function generateTaskForBuildFile(taskParameters, currentModuleInfo, gulpModulesInfo, filePathInProject) {
   ...
   return gulp.series(
      ...
      generateReadModuleCache(taskParameters, currentModuleInfo, true),
      ...
      generateWriteModuleCache(taskParameters, currentModuleInfo),
