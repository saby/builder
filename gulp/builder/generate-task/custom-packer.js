...
function generateSetSuperBundles(taskParameters, configs, root) {
   return function setSuperBundles() {
      return setSuperBundle(taskParameters, configs, root);
   };
}
...
function generateCollectPackagesTasks(configs, taskParameters, root, bundlesList) {
   ...
   return gulp.series(
      gulp.parallel(tasks),
      generateSetSuperBundles(taskParameters, configs, root)
   );
}
...
function generateTaskForCustomPack(taskParameters) {
   ...
   const
      ...
      results = {
         ...
         superBundles: {},
         excludedCSS: {},
         modulesWithGeneratedPackages: new Set()
      },
      bundlesList = new Set();
