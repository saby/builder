...
function generateTaskForBuildSingleModule(taskParameters, moduleInfo, modulesMap) {
   ...
   return function buildModule(done) {
      ...
      const sources = getModuleInputForBuild(taskParameters, moduleInfo, gulpSrcOptions);
      ...
      return (
         gulp
            ...
            .pipe(
               gulpIf(
                  config.isWmlPluginEnabled(moduleInfo),
            ...
            .pipe(
               gulpIf(
                  config.isDependenciesEnabled(moduleInfo),
