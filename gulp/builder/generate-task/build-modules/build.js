...
const packLibrary = require('../../plugins/pack-library'),
   ...
   applyTailwindCss = require('../../plugins/apply-tailwindcss');
   ...
   return function buildModule() {
      return (
         gulp
            ...
            .pipe(
               gulpIf(
                  !!(taskParameters.config.buildTailwindCss && moduleInfo.name === 'Tailwind'),
                  applyTailwindCss(moduleInfo)
               )
            )
            ...
            .pipe(
               gulpIf(
                  (!!moduleInfo.deprecatedWebPageTemplates) || config.generateUMD,
