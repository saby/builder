         ...
         try {
            ...
            if (useCompiledFiles(taskParameters, moduleInfo)) {
               ...
               if (result) {
                  ...
                  moduleInfo.cache.storeBuildedMarkup(relativeFilePathWithModule, {
                     nodeName: `html!${relativeFilePathWithModule.replace('.xhtml', '')}`,
                     text: result
                  });
                  ...
                  this.push(newFile);
                  taskParameters.cache.addOutputFile(relativeFilePathWithModule, outputMinFile, moduleInfo);
                  callback(null, file);
                  return;
               }
            ...
            const xhtmlFileName = transliterate(
               removeLeadingSlashes(
                  toSafePosix(relativeFilePathWithModule)
               )
            );
            ...
            if (errorBuild) {
               ...
               const [error, obj] = await execInPool(
                  taskParameters.pool,
                  'minifyJs',
                  [file.pPath, newText, moduleInfo.ESVersion, true]
               );
               ...
               if (error) {
                  ...
                  logger.error({
                     ...
                     error,
                     moduleInfo,
                     filePath: relativeSourcePath.replace('.xhtml', '.min.xhtml')
                  });
               } else {
                  newText = obj.code;
               ...
               moduleInfo.cache.storeBuildedMarkup(relativeFilePathWithModule, resultBuild);
            }
