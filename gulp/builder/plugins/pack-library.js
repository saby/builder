...
function getPrivatePartsCache(taskParameters, moduleInfo) {
   ...
   ).filter(currentFile => isPrivate(currentFile));
   const result = {};
   ...
   return through.obj(
      ...
      function onTransform(file, encoding, callback) {
         ...
         if (
            ...
            if (helpers.useCompiledFiles(taskParameters, moduleInfo)) {
               file.library = true;
               callback(null, file);
            } else {
               libraries.push(file);
            ...
            async(library) => {
                  ...
                  [
                     {
                        ...
                        typescriptOutputDir: moduleInfo.typescriptOutputDir,
                        ESVersion: taskParameters.config.ESVersion,
                        tailwindInfo: moduleInfo.tailwindInfo
                     },
                     moduleInfo.appRoot,
                     path.dirname(moduleInfo.output),
               ...
               if (error) {
                  ...
                  logger.error({
                     ...
                     error,
                     filePath: library.pRelativeSource(moduleInfo.path),
                     moduleInfo
                  });
                  ...
                  /**
                   * Add packed libraries in versioned_modules meta file if there are packed
                   * private dependencies with an appropriate content to be replaced further
                   * by jinnee
                   */
