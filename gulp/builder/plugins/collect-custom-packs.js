      ...
      function onTransform(file, encoding, callback) {
         ...
         try {
            ...
            configsArray.forEach((currentConfig) => {
               ...
               // we need to add custom package configuration for correct rebuild of superbundle
               // but if current interface module has no changes there is no need to rebuild
               // packages in current module
               if (moduleInfo.skipCustomPack) {
                  currentConfig.skipCustomPack = true;
               }
