...
module.exports = function declarePlugin(taskParameters, moduleInfo) {
   ...
   return through.obj(
      function onTransform(file, encoding, callback) {
          ...
          */
         if ((file.versioned || file.regionalized) && extensions.includes(file.pExtname)) {
         ...
         taskParameters.metrics.storePluginTime('presentation service meta - versioned_modules.json', startTime);
         callback(null, file);
      }
   );
};
