...
const BaseModuleInfo = require('../../common/classes/base-module-info');
...
class ModuleInfo extends BaseModuleInfo {
   constructor(baseModuleInfo, countries, outputPaths = {}, staticServer) {
      ...
      // реальная директория, в котором располагается модуль.
      // необходимо для корректной генерации sourceMap
      ...
      this.isUnitTestModule = this.isModuleUnitTest();
