...
function packInOrder(
   ...
   orderQueue = dg.getLoadOrder(taskParameters, modArray);
...
function generatePackage(
   ...
   if (filesToPack) {
      ...
      return filesToPackList.map((text) => {
         ...
         taskParameters.addVersionedModules(moduleName, [nameToStore]);
         taskParameters.addFilesToCopy(moduleName, [nameToStore]);
