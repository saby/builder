...
describe('run uglify-js', () => {
   ...
   it('complex test for typeof undefined', async() => {
      ...
      const result = await runMinifyJs('virtual.js', text, null, false);
      result.code.should.equal(
         '(function(){if("undefined"===typeof("undefined"===typeof tclosure||!tclosure?arguments[arguments.length-1]:tclosure))console.log(1)})();'
      );

      const resultForMarkup = await runMinifyJs('virtual.js', text, null, true);
