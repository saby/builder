...
describe('lib/parse-js-component', () => {
   ...
   it('should be navigation module', () => {
      const componentName = 'UIModule/dir/module';
   ...
   it('should have private deps property', () => {
   ...
   it('should have less deps', () => {
      ...
      const text = `define("${componentName}", ${JSON.stringify(componentDep)}, function(){});`;
      const { componentInfo } = parseJsComponent(text, { testsBuild: true });

      expect(componentInfo.lessDependencies).to.deep.equal(
         componentDep.map(v => v.replace('css!', ''))
      );
   });
   it('should add less from _styles', () => {
   ...
   it('should add less from _styles in object', () => {
      const componentName = 'UIModule/_dir/module';
      const stylesDep = [
         'UIModule/dir/first',
         'UIModule/dir/second',
   ...
   it('should add lest from _theme', () => {
      // Detecting fragments like
   ...
   it('should add less from _theme in object', () => {
      const componentName = 'UIModule/_dir/module';
      const stylesDep = [
         'UIModule/dir/first',
         'UIModule/dir/second',
   ...
   describe('webPage configuration', () => {
      it('should find webPage properties', () => {
