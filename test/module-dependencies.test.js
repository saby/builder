...
describe('module dependencies helpers', () => {
   it('getNodePath should return correct path', () => {
      ...
      result = mDepsHelpers.getNodePath('MyModule/myFile.meta.min.js');
      expect(result).equal('MyModule/myFile.min.js');
      result = mDepsHelpers.getNodePath('MyModule/myFile.meta.js');
      expect(result).equal('MyModule/myFile.js');
      result = mDepsHelpers.getNodePath('MyModule/myFile.meta.ts', '.ts', '');
      expect(result).equal('MyModule/myFile.js');
