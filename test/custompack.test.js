...
const root = toPosix(__dirname),
   ...
   Configuration = require('../gulp/builder/classes/configuration');
...
describe('custompack-intersects', () => {
   ...
   it('intersects-should-be-founded-and-splitted-by-interface-modules', async() => {
      ...
      await customPacker.collectAllIntersects(taskParams, applicationRoot, results);
