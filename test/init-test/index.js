...
function getPlatformModules() {
   ...
   return [
      ...
      new ModuleInfo(getModuleInfo('Meta', 'saby-types/Meta')),
      ...
      new ModuleInfo(getModuleInfo('EnvConfig', 'rmi/src/client/EnvConfig')),
      ...
      new ModuleInfo(getModuleInfo('ParametersWebAPI', 'rmi/src/client/ParametersWebAPI')),
      ...
      new ModuleInfo(getModuleInfo('UICore', 'saby-ui/UICore')),
      new ModuleInfo(getModuleInfo('UICommon', 'saby-ui/UICommon')),
      new ModuleInfo(getModuleInfo('Typescript', 'saby-typescript/Typescript')),
      new ModuleInfo(getModuleInfo('LocalizationConfigs', 'sbis-core/client/LocalizationConfigs'), null, { output: fixtureWSPath })
   ];
}
...
async function init() {
   if (!initialized) {
      try {
         ...
         await wsEnvironment.init(fixtureWSPath, resourcesPath, undefined, requiredModules);
