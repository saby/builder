...
describe('versionize-content', () => {
   ...
   it('versionize style content', async() => {
      ...
      currentModuleInfo.version = 'unit-tests';
      ...
      const checkVersionizeStyleResult = async(
         ...
         const result = await versionizeContent.versionizeStyles(currentFile, moduleInfo, options);
      ...
      // проверяем, подменяется ли регион при обработке ссылки
      await checkVersionizeStyleResult(
         currentModuleInfo,
         { skipLogs: false, cdnUrl: '/test/mycdn/', regions: ['KZ'] },
         'src: url(\'%{CDN_ROOT}fonts/TensorFont/1.0.3/%{REGION}/TensorFont/TensorFont.eot?#iefix\')',
         'src: url(\'/test/mycdn/fonts/TensorFont/1.0.3/KZ/TensorFont/TensorFont.eot?x_module=%{BUILDER_VERSION_STUB}#iefix\')',
         false,
         []
      );
      await checkVersionizeStyleResult(
         currentModuleInfo,
         { skipLogs: false, cdnUrl: '/test/mycdn/', regions: ['RU', 'KZ'] },
         'src: url(\'%{CDN_ROOT}fonts/TensorFont/1.0.3/%{REGION}/TensorFont/TensorFont.eot?#iefix\')',
         'src: url(\'/test/mycdn/fonts/TensorFont/1.0.3/%{REGION}/TensorFont/TensorFont.eot?x_module=%{BUILDER_VERSION_STUB}#iefix\')',
         false,
         []
      );
      ...
      await checkVersionizeStyleResult(
         currentModuleInfo,
         { skipLogs: false, cdnUrl: '/test/mycdn/' },
         'src: url(\'%{CDN_ROOT}fonts/TensorFont/1.0.3/TensorFont/TensorFont.eot?#iefix\')',
         'src: url(\'/test/mycdn/fonts/TensorFont/1.0.3/TensorFont/TensorFont.eot?x_module=%{BUILDER_VERSION_STUB}#iefix\')',
         false,
         []
      );

      // при наличии joinedMeta должны вставить честную версию билда
      currentModuleInfo.joinedMeta = true;
      await checkVersionizeStyleResult(
         currentModuleInfo,
         { skipLogs: false, cdnUrl: '/test/mycdn/', regions: ['KZ'] },
         'src: url(\'%{CDN_ROOT}fonts/TensorFont/1.0.3/%{REGION}/TensorFont/TensorFont.eot?#iefix\')',
         'src: url(\'/test/mycdn/fonts/TensorFont/1.0.3/KZ/TensorFont/TensorFont.eot?x_module=unit-tests#iefix\')',
         false,
         []
      );
      await checkVersionizeStyleResult(
         ...
         { skipLogs: false, cdnUrl: '/test/mycdn/', regions: ['RU', 'KZ'] },
         'src: url(\'%{CDN_ROOT}fonts/TensorFont/1.0.3/%{REGION}/TensorFont/TensorFont.eot?#iefix\')',
         'src: url(\'/test/mycdn/fonts/TensorFont/1.0.3/%{REGION}/TensorFont/TensorFont.eot?x_module=unit-tests#iefix\')',
         false,
         []
      );
      ...
      await checkVersionizeStyleResult(
         ...
         { skipLogs: false, cdnUrl: '/test/mycdn/' },
         'src: url(\'%{CDN_ROOT}fonts/TensorFont/1.0.3/TensorFont/TensorFont.eot?#iefix\')',
         'src: url(\'/test/mycdn/fonts/TensorFont/1.0.3/TensorFont/TensorFont.eot?x_module=unit-tests#iefix\')',
         false,
         []
      );

      delete currentModuleInfo.joinedMeta;
   ...
   it('versionize templates content', () => {
      ...
      const checkVersionizeTemplateResult = (
         ...
         const result = versionizeContent.versionizeTemplates(currentFile, moduleInfo, options);
         result.errors.should.equal(containsErrors);
         toArray(result.externalDependencies).should.have.members(externalDeps);
      ...
      checkVersionizeTemplateResult(
         currentModuleInfo,
         { skipLogs: false, cdnUrl: '/test/mycdn/' },
         'src="%{CDN_ROOT}RequireJS/test.css">',
         'src="/test/mycdn/RequireJS/test.css">',
         false,
         []
      );

      // проверяем, заменяется ли плейсхолдер региона в ссылке
      checkVersionizeTemplateResult(
         currentModuleInfo,
         { skipLogs: false, cdnUrl: '/test/mycdn/', regions: ['KZ'] },
         'src="%{CDN_ROOT}RequireJS/%{REGION}/test.css">',
         'src="/test/mycdn/RequireJS/KZ/test.css">',
         false,
         []
      );

      // также проверяем кейс с мультирегионами
      checkVersionizeTemplateResult(
         currentModuleInfo,
         { skipLogs: false, cdnUrl: '/test/mycdn/', regions: ['RU', 'KZ'] },
         'src="%{CDN_ROOT}RequireJS/%{REGION}/test.css">',
         'src="/test/mycdn/RequireJS/%{REGION}/test.css">',
         false,
         []
      );
