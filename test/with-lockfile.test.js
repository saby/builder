...
describe('lib/with-lockfile', () => {
   ...
   it('should call callback function', async() => {
      ...
      const lockFile = withLockfile.toFileName(taskParameters, 'file-1');
   ...
   it('should call callback sequence of functions', async() => {
      ...
      const lockFile = withLockfile.toFileName(taskParameters, 'file-2');
   ...
   it('should not call nested function', async() => {
      const lockFile = withLockfile.toFileName(taskParameters, 'file-3');
