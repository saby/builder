...
const { getCurrentNodePlugin } = require('../lib/helpers');
...
describe('check-module-dependencies', () => {
   ...
   const buildConfig = {
      rawConfig: {
         output: path.join(dirname, 'fixture/check-module-dependencies')
      }
   };
   before(async() => {
      await initTest();
   ...
   it('check module-dependencies flag must return errors list', async() => {
      ...
      const fixtureFolder = path.join(dirname, 'fixture/check-module-dependencies');
