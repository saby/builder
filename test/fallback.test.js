...
describe('lib/less/fallback', () => {
   it('should process value parens', () => {
      const storage = { };
      const file = {
         path: path.join(dirname, 'fixture/fallback', 'simple.less'),
         dirname: path.join(dirname, 'fixture/fallback'),
         base: 'simple'
      };
      const moduleInfo = {
         name: 'Module',
         path: path.join(dirname, 'fixture/fallback', 'Module'),
         appRoot: path.join(dirname, 'fixture/fallback')
      };
