...
describe('process sabytheme', () => {
   ...
   describe('get hsl params', () => {
      it('check params for variable without inheritance', () => {
         ...
         const result = getHslParams(currentProperties, currentProperties.primary_color);

         expect(result).to.deep.equal(currentProperties.primary_color.value);
      });
      ...
      it('check params for variable with inheritance in strict mode', () => {
         ...
         const result = getHslParams(currentProperties, currentProperties['primary_text-color']);
      ...
      it('check params for variable with multiple inheritance with disabled strict mode', () => {
         ...
         const result = getHslParams(currentProperties, currentProperties['primary_hover_text-color']);
   ...
   it('get correct parsed meta of sabytheme', async() => {
      ...
      const testResults = (themes) => {
         ...
         expect(
            sabyThemes.base_sabytheme.styles.primary_color.primary_color.value
         ).to.deep.equal({
            a: 1,
            h: 17.74194,
            l: 60,
         ...
         expect(
            sabyThemes.default_sabytheme.styles.primary_color.primary_color.value
         ).to.deep.equal({
            a: 1,
            h: 18,
            l: 60,
         ...
         expect(
            sabyThemes.default_sabytheme.styles.primary_color['primary_text-color'].value
         ).to.deep.equal(
            sabyThemes.base_sabytheme.styles.primary_color['primary_text-color'].value
         );
         expect(
            sabyThemes.default_sabytheme.styles.primary_color['primary_hover_text-color'].value
         ).to.deep.equal(
            sabyThemes.base_sabytheme.styles.primary_color['primary_hover_text-color'].value
         );
         ...
         expect(
            sabyThemes.blackblue_sabytheme.styles.primary_color['primary_text-color'].value
         ).to.deep.equal({
            a: 1,
            h: 185.454545454545,
            l: 8.62745098039216,
         ...
         expect(
            sabyThemes.blackblue_sabytheme.styles.primary_color.primary_color.value
         ).to.deep.equal(
            sabyThemes.default_sabytheme.styles.primary_color.primary_color.value
         );
         expect(
            sabyThemes.blackblue_sabytheme.styles.primary_color['primary_hover_text-color'].value
         ).to.deep.equal(
            sabyThemes.base_sabytheme.styles.primary_color['primary_hover_text-color'].value
         );
      };
   ...
   it('convert sabytheme to css', async() => {
      ...
      expect(result).to.be.equal('.t-base.primary_color {\n' +
