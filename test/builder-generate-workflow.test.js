...
describe('gulp/builder/generate-workflow.js', () => {
   ...
   it('check correct output of patches sequence', async() => {
      ...
      await checkChanges('/* patch 1 */', 'Modul/Modul', false, true);
      ...
      (await isRegularFile(path.join(changedFilesOutput, 'Modul'), 'Modul.min.js.gz')).should.equal(true);
      (await isRegularFile(path.join(changedFilesOutput, 'Modul'), 'Modul.min.js.br')).should.equal(true);
      ...
      await checkChanges('/* patch 1 */', 'Modul/Modul', false, false);
