...
describe('gulp/builder/generate-workflow.js', () => {
   ...
   describe('check interfaces build and packing', () => {
      ...
      it('sources enabled, joinedMeta disabled, 3 providers - 1 in base interface and 2 in different modules', async() => {
         ...
         const interfaceRouteContent = await fs.readJson(interfaceRoutePath);
         interfaceRouteContent.should.deep.equal({
            'ModuleWithAPI/_test/scope': [
               ...
               'ModuleWithAPI/_test/scope.js',
               'ModuleWithAPI/_test/scope.min.js'
            ],
            'ModuleWithAPI/scope': [
               'Module1/scope.js',
               ...
               'ModuleWithAPI/scope.js',
               'ModuleWithAPI/scope.min.js'
            ]
         });
      });
