...
function linkPlatform(sourceFolder) {
   ...
   return Promise.all([
      ...
      fs.copy(path.join(nodeModulesPath, 'saby-types/Meta'), path.join(sourceFolder, 'Meta')),
      ...
      fs.ensureSymlink(path.join(nodeModulesPath, 'rmi/src/client/ParametersWebAPI'), path.join(sourceFolder, 'ParametersWebAPI'), 'dir'),
