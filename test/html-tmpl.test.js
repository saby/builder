      ...
      describe('multiService', () => {
         describe('without application', () => {
            it('with resourcesUrl', () => {
               ...
               testMultiServiceResults(templatesConfig.app.requestConfig);
            });
      ...
      describe('single service', () => {
         describe('without application', () => {
            it('with resourcesUrl', () => {
               ...
               testSingleServiceResults(templatesConfig.app.requestConfig);
               templatesConfig.app.requestConfig.appRoot.should.equal('/');
               templatesConfig.app.requestConfig.wsRoot.should.equal('/resources/WS.Core/');
               templatesConfig.app.requestConfig.resourceRoot.should.equal('/resources/');
            });
            it('without resourcesUrl', () => {
               const templatesConfig = new TemplatesBuilder();
               templatesConfig.setCommonRootInfo({
               ...
               testSingleServiceResults(templatesConfig.app.requestConfig);
               templatesConfig.app.requestConfig.appRoot.should.equal('/');
               templatesConfig.app.requestConfig.wsRoot.should.equal('/WS.Core/');
               templatesConfig.app.requestConfig.resourceRoot.should.equal('/');
            });
         });
         describe('with application', () => {
            it('with resourcesUrl', () => {
               ...
               testSingleServiceResults(templatesConfig.app.requestConfig);
               templatesConfig.app.requestConfig.appRoot.should.equal('/someRoot/');
               templatesConfig.app.requestConfig.wsRoot.should.equal('/someRoot/resources/WS.Core/');
               templatesConfig.app.requestConfig.resourceRoot.should.equal('/someRoot/resources/');
            });
            it('without resourcesUrl', () => {
               const templatesConfig = new TemplatesBuilder();
               templatesConfig.setCommonRootInfo({
               ...
               testSingleServiceResults(templatesConfig.app.requestConfig);
               templatesConfig.app.requestConfig.appRoot.should.equal('/someRoot/');
               templatesConfig.app.requestConfig.wsRoot.should.equal('/someRoot/WS.Core/');
               templatesConfig.app.requestConfig.resourceRoot.should.equal('/someRoot/');
            });
         });
      });
   });
