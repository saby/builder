...
describe('getModuleInput', () => {
   ...
   describe('changedFiles meta has some files to build', () => {
      it('compile task - all meta.ts namespace should be added if at least 1 meta ts file is changed', async() => {
         const gulpConfig = {
            cache: './cache',
            modules: [{
               name: 'Module1',
      ...
      it('compile task - all meta.ts namespace should be added if s3mod file is changed', async() => {
         const gulpConfig = {
            cache: './cache',
            modules: [{
               name: 'Module1',
