 ...
 * @returns {string}
 */
function generateLinkForCss(themedModulesMap, cssModules, packagePath) {
   ...
   result += 'if (isMSIE) {';
   result += getDefinesForCss(themedModulesMap, cssModules, linkHref, packageSuffix, '_ie');
   result += '} else {';
   result += getDefinesForCss(themedModulesMap, cssModules, linkHref, packageSuffix, '');
   result += '}';
