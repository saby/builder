...
const { formatErrorMessage } = require('../../espree/common');
...
async function readModuleAndGetParamsNames(
   ...
   try {
      ...
      const message = `An error occurred while parsing compiled private dependency "${result.modulePath || currentDependency}".`;
